...
def timeseries_data(direction):
  #### disable automatic camera reset on 'Show'
  paraview.simple._DisableFirstRenderCameraReset()

  # create a new 'ADIOS2VTXReader'
  deformationbp = ADIOS2VTXReader(registrationName='deformation.bp', FileName='../output/AJ/deformation.bp')
  ...
  # Make the directory
  directory = f"linegraph_{direction}"
    
  # Parent Directory path
  parent_dir = "../output/AJ"
  ...
  # save data
  SaveData(f'../output/AJ/linegraph_{direction}/line{direction}_time.csv', proxy=plotOverLine1, WriteTimeSteps=1,
      Filenamesuffix='_%d',
  ...
  layout1.SetSize(1087, 793)

  #-----------------------------------
  # saving camera placements for views

  # current camera placement for renderView1
  renderView1.CameraPosition = [1000.0, 1750.0, 8039.697272912243]
