...
facet_tagsxdmf = Xdmf3ReaderS(registrationName='facet_tags.xdmf', FileName=['../output/AJ/facet_tags.xdmf'])
...
# save screenshot
SaveScreenshot('../output/plots/mesh_2D_EN.png', renderView1, ImageResolution=[3*1096, 3*793],
